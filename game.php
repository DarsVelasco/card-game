...
<head>
    ...
    <link href="https://fonts.googleapis.com/css2?family=Londrina+Sketch&family=Teko&display=swap" rel="stylesheet">
</head>
<body>

<div class="game-container">
    <h1>Card Matching Game</h1>
    <h3>Player: <?php echo htmlspecialchars($playerName); ?></h3>
